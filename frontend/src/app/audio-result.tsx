/**
 * Vaidya — Audio Result screen
 * Shows detailed audio analysis results
 */
...
export default function AudioResultScreen() {
  ...
  if (!session || !('audio_result' in session) || !session.audio_result) {
    return (
  ...
  const audio = session.audio_result;
...
const s = StyleSheet.create({
  ...
  confidence:  { ...TYPE.bodySmall, color: COLORS.textMuted },
