...
export const DEMO_HOSPITALS: HospitalListResponse = {
  results: [
    {
      id: 'demo-hosp-001',
      name: 'Primary Health Centre, Anna Nagar',
      hospital_type: 'phc',
    ...
    {
      id: 'demo-hosp-002',
      name: 'Community Health Centre, Kilpauk',
      hospital_type: 'chc',
      address: 'Kilpauk Garden Road, Chennai, Tamil Nadu 600010',
      latitude: 13.0827,
      longitude: 80.2492,
      distance_km: 3.4,
      phone: '044-26412136',
    ...
    {
      id: 'demo-hosp-004',
      name: 'ESI Hospital, KK Nagar',
      hospital_type: 'esic',
      address: 'KK Nagar, Chennai, Tamil Nadu 600078',
      latitude: 13.0389,
      longitude: 80.2013,
      distance_km: 4.1,
      phone: '044-23611433',
  ...
  total: 4,
  patient_location: { lat: 13.0827, lng: 80.2707, district: 'Chennai' },
};
