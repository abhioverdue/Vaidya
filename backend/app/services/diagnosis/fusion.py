...
async def run_all_models_concurrent(
    ...
    from app.services.diagnosis.audio_model import _load_audio_artifacts as load_audio
    from app.services.diagnosis.vision_model import _load_vision_model as load_vision
